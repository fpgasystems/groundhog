 ...
 * ---------------------------------------------------------------------------
 * Description   : 16-bit wide & 1024-word deep BRAM-based FIFO
 *                 There are some SSD controllers that require bigger FIFOs
 *                 than we had specified in the previous version. To avoid
 *                 timing issues we switchted to a BRAM-based FIFO. The BRAM
 *                 block is instantiated in this wrapper file.
 * ---------------------------------------------------------------------------
 * Changelog     : none
 * ------------------------------------------------------------------------- */
